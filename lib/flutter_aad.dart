...
class AADConfig{
  ...
  AADConfig({this.resource, this.clientID, this.redirectURI, List<String> scope}):this.scope = scope ?? [];
...
const V2_LOGIN_URI = 'https://login.microsoftonline.com/common/oauth2/v2.0/token';
const LOGIN_URI = 'https://login.microsoftonline.com/common/oauth2/token';
const V2_AUTH_URI = 'https://login.microsoftonline.com/common/oauth2/v2.0/authorize';
...
class FlutterAAD {
  String GetAuthCodeURIv1(AADConfig config) {
    ...
    var query = {"client_id": config.ClientID,
      "response_type": "code",
      "response_mode": "query",
